...
@JsonDeserialize(
    builder = BacktestsAvailabilityAgentsItemModel.Builder.class
)
public final class BacktestsAvailabilityAgentsItemModel {
  ...
  private BacktestsAvailabilityAgentsItemModel(String label, Optional<String> modelId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof BacktestsAvailabilityAgentsItemModel && equalTo((BacktestsAvailabilityAgentsItemModel) other);
  }
  ...
  private boolean equalTo(BacktestsAvailabilityAgentsItemModel other) {
  ...
  public interface LabelStage {
    ...
    Builder from(BacktestsAvailabilityAgentsItemModel other);
  }

  public interface _FinalStage {
    BacktestsAvailabilityAgentsItemModel build();
  ...
  public static final class Builder implements LabelStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(BacktestsAvailabilityAgentsItemModel other) {
    ...
    @java.lang.Override
    public BacktestsAvailabilityAgentsItemModel build() {
      return new BacktestsAvailabilityAgentsItemModel(label, modelId, provider, additionalProperties);
    }
