...
@JsonDeserialize(builder = TraceRequest.Builder.class)
public final class TraceRequest {
    ...
    private TraceRequest(
            ...
            Optional<List<SpanRequest>> spans,
    ...
    public int hashCode() {
        return Objects.hash(
                this.traceId, this.eventId, this.name, this.startedAt, this.endedAt, this.attributes, this.spans);
    }
    ...
    public static final class Builder implements TraceIdStage, _FinalStage {
        ...
        public TraceRequest build() {
            return new TraceRequest(
                    traceId, eventId, name, startedAt, endedAt, attributes, spans, additionalProperties);
        }
