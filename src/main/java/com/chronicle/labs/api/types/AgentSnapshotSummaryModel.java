...
@JsonDeserialize(
    builder = AgentSnapshotSummaryModel.Builder.class
)
public final class AgentSnapshotSummaryModel {
  ...
  private AgentSnapshotSummaryModel(String label, Optional<String> modelId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AgentSnapshotSummaryModel && equalTo((AgentSnapshotSummaryModel) other);
  }
  ...
  private boolean equalTo(AgentSnapshotSummaryModel other) {
  ...
  public interface LabelStage {
    ...
    Builder from(AgentSnapshotSummaryModel other);
  }

  public interface _FinalStage {
    AgentSnapshotSummaryModel build();
  ...
  public static final class Builder implements LabelStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(AgentSnapshotSummaryModel other) {
    ...
    @java.lang.Override
    public AgentSnapshotSummaryModel build() {
      return new AgentSnapshotSummaryModel(label, modelId, provider, additionalProperties);
    }
