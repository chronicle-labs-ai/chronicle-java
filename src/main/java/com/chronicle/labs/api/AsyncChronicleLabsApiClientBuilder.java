...
import com.chronicle.labs.api.core.LogConfig;
...
public class AsyncChronicleLabsApiClientBuilder {
   ...
   * Sets token
   */
  public AsyncChronicleLabsApiClientBuilder token(String token) {
    this.token = token;
    return this;
  }

  public AsyncChronicleLabsApiClientBuilder environment(Environment environment) {
    this.environment = environment;
    return this;
  }

  public AsyncChronicleLabsApiClientBuilder url(String url) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder initialRetryDelayMillis(long initialRetryDelayMillis) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder maxRetryDelayMillis(long maxRetryDelayMillis) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder retryJitterFactor(double retryJitterFactor) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder logging(LogConfig logging) {
   ...
   */
  public AsyncChronicleLabsApiClientBuilder addHeader(String name, String value) {
  ...
  public AsyncChronicleLabsApiClient build() {
    if (token == null) {
      throw new RuntimeException("Please provide token");
    }
    validateConfiguration();
    return new AsyncChronicleLabsApiClient(buildClientOptions());
  }
}
