...
public final class ClientOptions {
  ...
  private ClientOptions(Environment environment, Map<String, String> headers,
    ...
    this.headers.putAll(new HashMap<String,String>() {{put("User-Agent", "com.chronicle-labs.chronicle-sdk/0.0.10");put("X-Fern-Language", "JAVA");put("X-Fern-SDK-Name", "com.chronicle-labs:chronicle-sdk");put("X-Fern-SDK-Version", "0.0.10");}});
